...
const BIOHACKING_LENS_BY_PRODUCT = {
  en: {
    ...
    Retatrutide: { objective: 'Triple-incretin metabolic research', community: 'Appears in metabolic-health and body-composition conversations because it targets GLP-1, GIP and glucagon pathways.', evidence: 'Human phase-2 obesity research exists; it remains a clinical-development compound, not a general biohacking outcome.', map: 'METABOLIC' },
    ...
    Glutathione: { objective: 'Redox & antioxidant-system research', community: 'Appears in recovery, skin and oxidative-stress conversations.', evidence: 'It is not a peptide; broad detox or glow claims exceed what a formulation-specific evidence review can support.', map: 'CELLULAR HEALTH' },
  ...
  es: {
    ...
    Glutathione: { objective: 'Investigaci\u00f3n de redox y sistemas antioxidantes', community: 'Aparece en conversaciones sobre recuperaci\u00f3n, piel y estr\u00e9s oxidativo.', evidence: 'No es un p\u00e9ptido; las afirmaciones amplias de detox o “glow” exceden una revisi\u00f3n de evidencia dependiente de formulaci\u00f3n.', map: 'SALUD CELULAR' },
