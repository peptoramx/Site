...
const BIOHACKING_LENS = {
  ...
  es: {
    ...
    aesthetic: { objective: 'Investigaci\u00f3n de piel y tejido', community: 'Suele aparecer en conversaciones sobre calidad de piel, tejido conectivo y recuperaci\u00f3n.', evidence: 'El inter\u00e9s mecan\u00edstico no establece un resultado est\u00e9tico o terap\u00e9utico.', map: 'PIEL Y TEJIDOS' },
...
const BIOHACKING_LENS_BY_PRODUCT = {
  en: {
    Semaglutide: { objective: 'GLP-1 metabolic-signalling research', community: 'Appears in appetite regulation, glucose control and body-composition conversations.', evidence: 'It has an established clinical evidence base for specific approved indications; that evidence does not validate every formulation or use context discussed online.', map: 'METABOLIC' },
    Tirzepatide: { objective: 'Dual GLP-1 / GIP metabolic research', community: 'Appears in metabolic-health and body-composition conversations because it engages two incretin pathways.', evidence: 'Clinical evidence exists for defined indications. It should not be reduced to a generic “weight-loss peptide” or treated as interchangeable with GLP-1-only compounds.', map: 'METABOLIC' },
    Retatrutide: { objective: 'Triple-receptor metabolic research', community: 'Appears in metabolic-health and body-composition conversations because it targets GLP-1, GIP and glucagon pathways.', evidence: 'Human phase-2 obesity research exists; it remains a clinical-development compound, not a general biohacking outcome.', map: 'METABOLIC' },
    Cagrilintide: { objective: 'Amylin-pathway metabolic research', community: 'Appears in satiety and appetite-regulation conversations, often alongside incretin research.', evidence: 'Its research question is distinct from GLP-1 signalling. Combination-study interest does not mean the combination is appropriate outside its studied context.', map: 'METABOLIC' },
    Mazdutide: { objective: 'GLP-1 / glucagon metabolic research', community: 'Appears in discussions of energy balance, weight regulation and multi-agonist biology.', evidence: 'Clinical-development data are compound- and population-specific; multi-agonist mechanisms should not be collapsed into a single expected outcome.', map: 'METABOLIC' },
    Survodutide: { objective: 'GLP-1 / glucagon metabolic research', community: 'Appears in metabolic and liver-health research conversations because of dual-receptor biology.', evidence: 'Development evidence is indication-specific and does not support generic body-composition claims.', map: 'METABOLIC' },
    'GLP-1': { objective: 'Incretin-pathway reference', community: 'Appears as the umbrella term in appetite, glucose and metabolic-health conversations.', evidence: 'GLP-1 is a biological pathway, not one interchangeable product; evidence, risks and regulatory status depend on the specific molecule.', map: 'METABOLIC' },
    '5-Amino-1MQ': { objective: 'NNMT & cellular-metabolism research', community: 'Appears in metabolic-flexibility and body-composition discussions.', evidence: 'The conversation is largely early-stage and preclinical. Mechanistic interest is not evidence of a human metabolic or physique outcome.', map: 'METABOLIC' },
    'Lipo-C': { objective: 'Formulation-specific metabolic reference', community: 'Appears in wellness and body-composition conversations as a named formulation.', evidence: 'Its research profile cannot be inferred from the label alone; composition and supporting evidence must be verified product by product.', map: 'METABOLIC' },
    'Lipo-C + B12': { objective: 'Formulation-specific metabolic reference', community: 'Appears in wellness and body-composition conversations as a named formulation with B12.', evidence: 'A formulation name is not an evidence category. Composition, route and clinical support must be assessed separately.', map: 'METABOLIC' },
    'CJC-1295 (With DAC)': { objective: 'Long-acting GHRH-analogue research', community: 'Appears in growth-hormone and recovery conversations because DAC changes the compound\'s exposure profile.', evidence: 'It is not interchangeable with CJC no DAC. Hormonal signalling research is not a performance or body-composition recommendation.', map: 'PERFORMANCE' },
    Ipamorelin: { objective: 'Ghrelin-receptor & GH-secretagogue research', community: 'Appears in GH-axis and recovery conversations.', evidence: 'Mechanistic discussion around GH release does not establish a recovery, sleep or physique outcome.', map: 'PERFORMANCE' },
    'Sermorelin Acetate': { objective: 'GHRH-axis research', community: 'Appears in endogenous GH-signalling conversations.', evidence: 'It should be distinguished from GH itself and from other GHRH analogues; clinical context matters.', map: 'PERFORMANCE' },
    'Hexarelin Acetate': { objective: 'Ghrelin-receptor & GH-secretagogue research', community: 'Appears in GH-axis discussions, often alongside other GHRPs.', evidence: 'Receptor activity and endocrine effects require clinical context; this is not a performance protocol.', map: 'PERFORMANCE' },
    'GHRP-6 Acetate': { objective: 'Ghrelin-pathway & appetite-signalling research', community: 'Appears in GH-axis and appetite-related conversations.', evidence: 'Appetite signalling is a separate biological effect, not a side note; online physique claims oversimplify the pathway.', map: 'PERFORMANCE' },
    'HGH 191AA (Somatropin)': { objective: 'Growth-hormone biology reference', community: 'Appears in performance and body-composition discussions.', evidence: 'Somatropin is a regulated medicine for specific indications. Its presence in biohacking discourse does not create a non-medical use case.', map: 'PERFORMANCE' },
    'HGH Fragment 176-191': { objective: 'GH-fragment & lipolysis research', community: 'Appears in body-composition conversations as a GH fragment rather than full growth hormone.', evidence: 'Fragment research should not be treated as evidence for a fat-loss result in people.', map: 'BODY COMPOSITION' },
    'IGF-1 LR3': { objective: 'IGF-1 signalling research', community: 'Appears in muscle-growth and recovery conversations.', evidence: 'IGF signalling has broad biological effects and meaningful risk considerations; experimental analogue discussion is not a physique recommendation.', map: 'PERFORMANCE' },
    'IGF-DES': { objective: 'IGF-1 receptor-signalling research', community: 'Appears in hypertrophy and local growth-factor conversations.', evidence: 'Research framing does not establish selective muscle effects or safety in a biohacking context.', map: 'PERFORMANCE' },
    Follistatin: { objective: 'Myostatin / activin-pathway research', community: 'Appears in muscle-mass conversations because of its relationship to activin-family signalling.', evidence: 'The pathway is biologically consequential and complex. Simplistic “myostatin blocker” claims are not an evidence profile.', map: 'PERFORMANCE' },
    'TB-500 (Thymosin B4 Acetate)': { objective: 'Actin dynamics & tissue-response research', community: 'Appears in tissue, tendon and recovery conversations.', evidence: 'Much of the discussion is preclinical or mechanistic; it does not establish human injury recovery outcomes.', map: 'SKIN & TISSUE' },
    KPV: { objective: 'Inflammatory-signalling research', community: 'Appears in gut, skin and inflammatory-pathway conversations.', evidence: 'Mechanistic and early research interest should not be translated into treatment or symptom claims.', map: 'CELLULAR HEALTH' },
    'GHK-Cu': { objective: 'Copper-peptide & dermal-signalling research', community: 'Appears in skin quality, collagen and connective-tissue conversations.', evidence: 'Research interest in dermal pathways does not establish a cosmetic or regenerative outcome for a specific product.', map: 'SKIN & TISSUE' },
    Cerebrolysin: { objective: 'Neurotrophic peptide-mixture research', community: 'Appears in neurodegeneration and cognitive-rehabilitation conversations.', evidence: 'It is a complex peptide mixture with context-specific clinical literature; it should not be framed as a general nootropic.', map: 'COGNITION' },
    DSIP: { objective: 'Sleep-regulation research', community: 'Appears in sleep and stress conversations.', evidence: 'The research history is mixed and limited; it does not establish a sleep outcome or a self-directed protocol.', map: 'COGNITION' },
    'Ara-290': { objective: 'Erythropoietin-derived tissue-protection research', community: 'Appears in nerve, pain and inflammatory-signalling conversations.', evidence: 'Research is indication-specific and should not be converted into broad recovery or symptom claims.', map: 'CELLULAR HEALTH' },
    'SS-31': { objective: 'Mitochondrial-targeting research', community: 'Appears in mitochondrial resilience and cellular-energy conversations.', evidence: 'Mechanistic mitochondrial interest does not establish an anti-aging or performance outcome.', map: 'LONGEVITY' },
    'L-Carnitine': { objective: 'Fatty-acid transport & exercise-metabolism research', community: 'Appears in energy, training and body-composition conversations.', evidence: 'It is not a peptide and outcomes depend on formulation, population and studied endpoint.', map: 'PERFORMANCE' },
    'AOD-9604': { objective: 'GH-fragment metabolic research', community: 'Appears in body-composition conversations.', evidence: 'Early and formulation-specific research does not establish a general fat-loss outcome.', map: 'BODY COMPOSITION' },
    Epitalon: { objective: 'Aging-biology & circadian research', community: 'Appears in longevity and sleep conversations.', evidence: 'Longevity claims substantially exceed the quality and scope of available human evidence.', map: 'LONGEVITY' },
    'Thymosin Alpha-1': { objective: 'Immune-modulation research', community: 'Appears in immune-resilience conversations.', evidence: 'Immune-active compounds require indication-specific clinical context; this is not a general immunity claim.', map: 'CELLULAR HEALTH' },
    Thymalin: { objective: 'Thymic-peptide & immune research', community: 'Appears in immune-aging and resilience conversations.', evidence: 'Evidence and regulatory context vary by jurisdiction and indication; avoid generalized immune claims.', map: 'CELLULAR HEALTH' },
    'LL-37': { objective: 'Antimicrobial-peptide research', community: 'Appears in skin, wound and innate-immunity conversations.', evidence: 'Antimicrobial and inflammatory biology is complex; research does not establish a safe treatment context.', map: 'CELLULAR HEALTH' },
    VIP: { objective: 'Neuropeptide & vasoactive signalling research', community: 'Appears in inflammatory, respiratory and autonomic-signalling conversations.', evidence: 'Its broad physiological activity makes simplistic wellness claims inappropriate.', map: 'CELLULAR HEALTH' },
    FOXO4: { objective: 'Cellular-senescence research', community: 'Appears in longevity and senolytic discussions.', evidence: 'The senolytic conversation is largely preclinical and experimental; it does not establish anti-aging effects in people.', map: 'LONGEVITY' },
    'Kisspeptin-10': { objective: 'Reproductive-endocrine signalling research', community: 'Appears in hormone and fertility-axis conversations.', evidence: 'This pathway requires clinical context; it is not a vitality or performance shortcut.', map: 'CELLULAR HEALTH' },
    Glutathione: { objective: 'Redox & antioxidant-system research', community: 'Appears in recovery, skin and oxidative-stress conversations.', evidence: 'It is a tripeptide; broad detox or glow claims exceed what a formulation-specific evidence review can support.', map: 'CELLULAR HEALTH' },
    'PT-141': { objective: 'Melanocortin-receptor research', community: 'Appears in sexual-function and libido conversations.', evidence: 'It is not a generic performance compound; endocrine and cardiovascular context matters.', map: 'HORMONAL HEALTH' },
    HCG: { objective: 'Gonadotropin & reproductive-endocrine research', community: 'Appears in fertility and hormone-axis conversations.', evidence: 'It is a regulated hormone medicine in specific clinical contexts, not a general vitality tool.', map: 'HORMONAL HEALTH' },
    'Melanotan I': { objective: 'Melanocortin & pigmentation research', community: 'Appears in tanning and pigmentation conversations.', evidence: 'Pigmentation-pathway discussion does not establish product safety or a cosmetic recommendation.', map: 'SKIN & TISSUE' },
    'Melanotan II': { objective: 'Melanocortin & pigmentation research', community: 'Appears in tanning, libido and melanocortin conversations.', evidence: 'Its multiple pathway effects make casual lifestyle claims especially misleading.', map: 'SKIN & TISSUE' },
    'Snap-8': { objective: 'Cosmetic-peptide formulation research', community: 'Appears in expression-line and topical-cosmetic conversations.', evidence: 'Evidence is formulation- and application-specific; it should not be equated with prescription neuromodulators.', map: 'SKIN & TISSUE' },
    'Lemon Bottle': { objective: 'Formulation-specific aesthetic reference', community: 'Appears in aesthetic and body-contouring conversations.', evidence: 'A brand or formulation name is not a mechanism or evidence profile; composition and regulatory status must be verified.', map: 'SKIN & TISSUE' },
    'Botulinum Toxin': { objective: 'Neuromuscular signalling reference', community: 'Appears in aesthetic and therapeutic conversations.', evidence: 'It is a potent regulated medicine with indication-specific clinical use; it is not a casual biohacking reference.', map: 'SKIN & TISSUE' },
    'Hyaluronic Acid': { objective: 'Extracellular-matrix & hydration reference', community: 'Appears in skin, joint and aesthetic conversations.', evidence: 'It is not a peptide; outcomes depend on formulation and clinical or cosmetic context.', map: 'SKIN & TISSUE' },
    'CJC-1295 (No DAC) + Ipamorelin': { objective: 'Combined GH-axis research', community: 'Appears in GH-axis and recovery discussions.', evidence: 'A combination is its own research question; individual mechanisms do not prove a combined outcome.', map: 'PERFORMANCE' },
    'CagriSema Standard': { objective: 'Amylin / incretin combination research', community: 'Appears in appetite and metabolic-health conversations.', evidence: 'Combination evidence must be tied to the exact molecules and studied formulation, not inferred from a stack name.', map: 'METABOLIC' },
    'CagriSema High Concentration': { objective: 'Amylin / incretin combination research', community: 'Appears in the same metabolic conversations as CagriSema Standard.', evidence: 'A higher-concentration label does not create new efficacy evidence or a different clinical outcome.', map: 'METABOLIC' },
    'BPC-157 + TB-500 Standard': { objective: 'Tissue-response combination research', community: 'Appears in injury, tendon and recovery conversations.', evidence: 'There is no independent clinical evidence for the combination; component literature cannot simply be combined.', map: 'SKIN & TISSUE' },
    'BPC-157 + TB-500 High Concentration': { objective: 'Tissue-response combination research', community: 'Appears in the same conversations as the standard BPC-157 + TB-500 reference.', evidence: 'Concentration does not convert a speculative combination into an independently validated intervention.', map: 'SKIN & TISSUE' },
    'Bacteriostatic Water / PBS': { objective: 'Laboratory preparation reference', community: 'Appears in discussions of laboratory handling and documentation.', evidence: 'Material context is not dosage or administration guidance.', map: 'RESEARCH TOOLS' },
    'Benzyl Alcohol 0.9%': { objective: 'Laboratory preservative reference', community: 'Appears in discussions of research preparation and stability.', evidence: 'Compatibility depends on the exact material and documented laboratory protocol.', map: 'RESEARCH TOOLS' },
    'Acetic Acid 0.6%': { objective: 'Laboratory solubility reference', community: 'Appears in discussions of compound solubility and preparation.', evidence: 'It is a laboratory context item, not a device or administration instruction.', map: 'RESEARCH TOOLS' },
    'MOTS-c': { objective: 'Mitochondrial signalling & exercise-metabolism research', community: 'Appears in conversations about exercise adaptation, mitochondrial biology and metabolic flexibility.', evidence: 'Human work describes endogenous MOTS-c biology and exercise-related signals; it does not establish performance enhancement from an administered product.', map: 'LONGEVITY' },
    Tesamorelin: { objective: 'GHRH & visceral-adiposity research', community: 'Appears in conversations about visceral fat, body composition and the GH axis.', evidence: 'Human research examines visceral adiposity in defined clinical settings; it should not be turned into a general physique outcome.', map: 'BODY COMPOSITION' },
    ...
    Semax: { objective: 'Neurotrophin & neuroplasticity research', community: 'Appears in focus, cognitive-performance and neuroplasticity conversations.', evidence: 'Much of the BDNF / TrkB mechanism discussion comes from cell and animal work; it does not establish a personal cognitive outcome.', map: 'COGNITION' },
    Selank: { objective: 'Stress-regulation & GABAergic research', community: 'Appears in anxiety-related signalling and calm-cognition conversations.', evidence: 'The literature includes GABA-related preclinical work and limited regional clinical research; it does not establish safety, approval or a personal outcome.', map: 'COGNITION' },
  },
  es: {
    Semaglutide: { objective: 'Investigaci\u00f3n de se\u00f1alizaci\u00f3n metab\u00f3lica GLP-1', community: 'Aparece en conversaciones sobre regulaci\u00f3n del apetito, glucosa y composici\u00f3n corporal.', evidence: 'Tiene una base cl\u00ednica establecida para indicaciones aprobadas espec\u00edficas; eso no valida toda formulaci\u00f3n o contexto de uso discutido en l\u00ednea.', map: 'METAB\u00d3LICO' },
    Tirzepatide: { objective: 'Investigaci\u00f3n metab\u00f3lica dual GLP-1 / GIP', community: 'Aparece en conversaciones de salud metab\u00f3lica y composici\u00f3n corporal porque involucra dos v\u00edas de incretinas.', evidence: 'Existe evidencia cl\u00ednica para indicaciones definidas. No debe reducirse a un “p\u00e9ptido para bajar de peso” ni tratarse como equivalente a compuestos s\u00f3lo GLP-1.', map: 'METAB\u00d3LICO' },
    Retatrutide: { objective: 'Investigaci\u00f3n metab\u00f3lica de triple incretina', community: 'Aparece en conversaciones de salud metab\u00f3lica y composici\u00f3n corporal porque apunta a las v\u00edas GLP-1, GIP y glucag\u00f3n.', evidence: 'Existe investigaci\u00f3n humana fase 2 en obesidad; sigue siendo un compuesto en desarrollo cl\u00ednico, no un resultado general de biohacking.', map: 'METAB\u00d3LICO' },
    Cagrilintide: { objective: 'Investigaci\u00f3n metab\u00f3lica de la v\u00eda de amilina', community: 'Aparece en conversaciones sobre saciedad y regulaci\u00f3n del apetito, frecuentemente junto a investigaci\u00f3n de incretinas.', evidence: 'Su pregunta de investigaci\u00f3n es distinta a la se\u00f1alizaci\u00f3n GLP-1. El inter\u00e9s en estudios combinados no vuelve apropiada una combinaci\u00f3n fuera de su contexto estudiado.', map: 'METAB\u00d3LICO' },
    Mazdutide: { objective: 'Investigaci\u00f3n metab\u00f3lica GLP-1 / glucag\u00f3n', community: 'Aparece en conversaciones sobre balance energ\u00e9tico, regulaci\u00f3n de peso y biolog\u00eda multagonista.', evidence: 'Los datos de desarrollo cl\u00ednico son espec\u00edficos del compuesto y poblaci\u00f3n; los mecanismos multagonistas no deben colapsarse en un solo resultado esperado.', map: 'METAB\u00d3LICO' },
    Survodutide: { objective: 'Investigaci\u00f3n metab\u00f3lica GLP-1 / glucag\u00f3n', community: 'Aparece en conversaciones de investigaci\u00f3n metab\u00f3lica y hep\u00e1tica por su biolog\u00eda de doble receptor.', evidence: 'La evidencia de desarrollo es espec\u00edfica de indicaci\u00f3n y no respalda afirmaciones generales de composici\u00f3n corporal.', map: 'METAB\u00d3LICO' },
    'GLP-1': { objective: 'Referencia de la v\u00eda de incretinas', community: 'Aparece como t\u00e9rmino paraguas en conversaciones de apetito, glucosa y salud metab\u00f3lica.', evidence: 'GLP-1 es una v\u00eda biol\u00f3gica, no un producto intercambiable; evidencia, riesgos y estatus regulatorio dependen de la mol\u00e9cula espec\u00edfica.', map: 'METAB\u00d3LICO' },
    '5-Amino-1MQ': { objective: 'Investigaci\u00f3n de NNMT y metabolismo celular', community: 'Aparece en conversaciones sobre flexibilidad metab\u00f3lica y composici\u00f3n corporal.', evidence: 'La conversaci\u00f3n es en gran parte temprana y precl\u00ednica. El inter\u00e9s mecan\u00edstico no prueba un resultado metab\u00f3lico o de f\u00edsico humano.', map: 'METAB\u00d3LICO' },
    'Lipo-C': { objective: 'Referencia metab\u00f3lica dependiente de formulaci\u00f3n', community: 'Aparece en conversaciones de bienestar y composici\u00f3n corporal como formulaci\u00f3n nombrada.', evidence: 'Su perfil de investigaci\u00f3n no se puede inferir s\u00f3lo por la etiqueta; composici\u00f3n y evidencia deben verificarse producto por producto.', map: 'METAB\u00d3LICO' },
    'Lipo-C + B12': { objective: 'Referencia metab\u00f3lica dependiente de formulaci\u00f3n', community: 'Aparece en conversaciones de bienestar y composici\u00f3n corporal como formulaci\u00f3n nombrada con B12.', evidence: 'Un nombre de formulaci\u00f3n no es una categor\u00eda de evidencia. Composici\u00f3n, v\u00eda y soporte cl\u00ednico deben evaluarse por separado.', map: 'METAB\u00d3LICO' },
    'CJC-1295 (With DAC)': { objective: 'Investigaci\u00f3n de an\u00e1logo GHRH de acci\u00f3n prolongada', community: 'Aparece en conversaciones sobre hormona de crecimiento y recuperaci\u00f3n porque DAC cambia el perfil de exposici\u00f3n del compuesto.', evidence: 'No es intercambiable con CJC no DAC. La investigaci\u00f3n de se\u00f1alizaci\u00f3n hormonal no es una recomendaci\u00f3n de rendimiento o composici\u00f3n corporal.', map: 'RENDIMIENTO' },
    Ipamorelin: { objective: 'Investigaci\u00f3n del receptor de grelina y secretagogo de GH', community: 'Aparece en conversaciones sobre eje GH y recuperaci\u00f3n.', evidence: 'La discusi\u00f3n mecan\u00edstica sobre liberaci\u00f3n de GH no establece un resultado de recuperaci\u00f3n, sue\u00f1o o f\u00edsico.', map: 'RENDIMIENTO' },
    'Sermorelin Acetate': { objective: 'Investigaci\u00f3n del eje GHRH', community: 'Aparece en conversaciones sobre se\u00f1alizaci\u00f3n end\u00f3gena de GH.', evidence: 'Debe distinguirse de GH y de otros an\u00e1logos de GHRH; el contexto cl\u00ednico importa.', map: 'RENDIMIENTO' },
    'Hexarelin Acetate': { objective: 'Investigaci\u00f3n del receptor de grelina y secretagogo de GH', community: 'Aparece en discusiones del eje GH, con frecuencia junto a otros GHRP.', evidence: 'La actividad de receptor y los efectos endocrinos requieren contexto cl\u00ednico; no es un protocolo de rendimiento.', map: 'RENDIMIENTO' },
    'GHRP-6 Acetate': { objective: 'Investigaci\u00f3n de la v\u00eda de grelina y se\u00f1alizaci\u00f3n de apetito', community: 'Aparece en conversaciones sobre eje GH y apetito.', evidence: 'La se\u00f1alizaci\u00f3n del apetito es un efecto biol\u00f3gico aparte, no una nota secundaria; afirmaciones de f\u00edsico en l\u00ednea simplifican en exceso la v\u00eda.', map: 'RENDIMIENTO' },
    'HGH 191AA (Somatropin)': { objective: 'Referencia de biolog\u00eda de hormona de crecimiento', community: 'Aparece en conversaciones sobre rendimiento y composici\u00f3n corporal.', evidence: 'Somatropin es un medicamento regulado para indicaciones espec\u00edficas. Su presencia en biohacking no crea un caso de uso no m\u00e9dico.', map: 'RENDIMIENTO' },
    'HGH Fragment 176-191': { objective: 'Investigaci\u00f3n de fragmento de GH y lip\u00f3lisis', community: 'Aparece en conversaciones de composici\u00f3n corporal como fragmento de GH, no como hormona de crecimiento completa.', evidence: 'La investigaci\u00f3n del fragmento no debe tratarse como evidencia de un resultado de p\u00e9rdida de grasa en personas.', map: 'COMPOSICI\u00d3N CORPORAL' },
    'IGF-1 LR3': { objective: 'Investigaci\u00f3n de se\u00f1alizaci\u00f3n IGF-1', community: 'Aparece en conversaciones sobre crecimiento muscular y recuperaci\u00f3n.', evidence: 'La se\u00f1alizaci\u00f3n IGF tiene efectos biol\u00f3gicos amplios y consideraciones de riesgo relevantes; hablar de an\u00e1logos experimentales no es una recomendaci\u00f3n de f\u00edsico.', map: 'RENDIMIENTO' },
    'IGF-DES': { objective: 'Investigaci\u00f3n de se\u00f1alizaci\u00f3n de receptor IGF-1', community: 'Aparece en conversaciones sobre hipertrofia y factores de crecimiento locales.', evidence: 'El marco de investigaci\u00f3n no establece efectos musculares selectivos ni seguridad en un contexto de biohacking.', map: 'RENDIMIENTO' },
    Follistatin: { objective: 'Investigaci\u00f3n de la v\u00eda de miostatina / activina', community: 'Aparece en conversaciones sobre masa muscular por su relaci\u00f3n con se\u00f1alizaci\u00f3n de la familia activina.', evidence: 'La v\u00eda es biol\u00f3gicamente relevante y compleja. Afirmaciones simplistas de “bloqueador de miostatina” no constituyen un perfil de evidencia.', map: 'RENDIMIENTO' },
    'TB-500 (Thymosin B4 Acetate)': { objective: 'Investigaci\u00f3n de din\u00e1mica de actina y respuesta de tejidos', community: 'Aparece en conversaciones sobre tejido, tend\u00f3n y recuperaci\u00f3n.', evidence: 'Gran parte de la conversaci\u00f3n es precl\u00ednica o mecan\u00edstica; no establece resultados de recuperaci\u00f3n de lesiones humanas.', map: 'PIEL Y TEJIDOS' },
    KPV: { objective: 'Investigaci\u00f3n de se\u00f1alizaci\u00f3n inflamatoria', community: 'Aparece en conversaciones sobre intestino, piel y v\u00edas inflamatorias.', evidence: 'El inter\u00e9s mecan\u00edstico y temprano no debe traducirse en afirmaciones de tratamiento o s\u00edntomas.', map: 'SALUD CELULAR' },
    'GHK-Cu': { objective: 'Investigaci\u00f3n de p\u00e9ptido de cobre y se\u00f1alizaci\u00f3n d\u00e9rmica', community: 'Aparece en conversaciones sobre calidad de piel, col\u00e1geno y tejido conectivo.', evidence: 'El inter\u00e9s en v\u00edas d\u00e9rmicas no establece un resultado cosm\u00e9tico o regenerativo para un producto espec\u00edfico.', map: 'PIEL Y TEJIDOS' },
    'MOTS-c': { objective: 'Investigaci\u00f3n de se\u00f1alizaci\u00f3n mitocondrial y metabolismo del ejercicio', community: 'Aparece en conversaciones sobre adaptaci\u00f3n al ejercicio, biolog\u00eda mitocondrial y flexibilidad metab\u00f3lica.', evidence: 'El trabajo humano describe biolog\u00eda end\u00f3gena de MOTS-c y se\u00f1ales relacionadas con ejercicio; no demuestra mejora del rendimiento por un producto administrado.', map: 'LONGEVIDAD' },
    Tesamorelin: { objective: 'Investigaci\u00f3n de GHRH y adiposidad visceral', community: 'Aparece en conversaciones sobre grasa visceral, composici\u00f3n corporal y el eje de GH.', evidence: 'La investigaci\u00f3n humana examina adiposidad visceral en contextos cl\u00ednicos definidos; no debe convertirse en un resultado general de f\u00edsico.', map: 'COMPOSICI\u00d3N CORPORAL' },
    ...
    'BPC-157': { objective: 'Investigaci\u00f3n de se\u00f1alizaci\u00f3n de tejidos y reparaci\u00f3n', community: 'Aparece en conversaciones sobre lesiones, tend\u00f3n y recuperaci\u00f3n.', evidence: 'Gran parte de la conversaci\u00f3n es precl\u00ednica. El inter\u00e9s de investigaci\u00f3n no establece eficacia cl\u00ednica, calidad del producto ni un resultado de recuperaci\u00f3n.', map: 'PIEL Y TEJIDOS' },
    GLOW: { objective: 'Investigaci\u00f3n multiv\u00eda de tejidos y d\u00e9rmica', community: 'Aparece en conversaciones sobre piel, tejido conectivo y recuperaci\u00f3n como el stack de referencia BPC-157 + TB-500 + GHK-Cu.', evidence: 'No existe evidencia cl\u00ednica independiente para esta combinaci\u00f3n de tres compuestos; la literatura de componentes no se puede sumar como un solo resultado.', map: 'PIEL Y TEJIDOS' },
    KLOW: { objective: 'Investigaci\u00f3n de se\u00f1alizaci\u00f3n de tejidos, d\u00e9rmica e inflamatoria', community: 'Aparece en las mismas conversaciones que GLOW, con KPV a\u00f1adido a la composici\u00f3n de referencia.', evidence: 'No existe evidencia cl\u00ednica independiente para esta combinaci\u00f3n de cuatro compuestos; debe evaluarse como una pregunta de investigaci\u00f3n propia.', map: 'PIEL Y TEJIDOS' },
    Semax: { objective: 'Investigaci\u00f3n de neurotrofinas y neuroplasticidad', community: 'Aparece en conversaciones sobre enfoque, rendimiento cognitivo y neuroplasticidad.', evidence: 'Gran parte de la conversaci\u00f3n sobre BDNF / TrkB proviene de trabajo celular y animal; no establece un resultado cognitivo personal.', map: 'COGNICI\u00d3N' },
    Selank: { objective: 'Investigaci\u00f3n de regulaci\u00f3n del estr\u00e9s y GABA', community: 'Aparece en conversaciones sobre se\u00f1alizaci\u00f3n relacionada con ansiedad y cognici\u00f3n en calma.', evidence: 'La literatura incluye trabajo precl\u00ednico relacionado con GABA y estudios cl\u00ednicos regionales limitados; no establece seguridad, aprobaci\u00f3n ni un resultado personal.', map: 'COGNICI\u00d3N' },
    'PT-141': { objective: 'Investigaci\u00f3n de receptores de melanocortina', community: 'Aparece en conversaciones sobre funci\u00f3n sexual y libido.', evidence: 'No es un compuesto gen\u00e9rico de rendimiento; el contexto endocrino y cardiovascular importa.', map: 'SALUD HORMONAL' },
    HCG: { objective: 'Investigaci\u00f3n de gonadotropina y endocrinolog\u00eda reproductiva', community: 'Aparece en conversaciones sobre fertilidad y el eje hormonal.', evidence: 'Es una hormona regulada en contextos cl\u00ednicos espec\u00edficos, no una herramienta general de vitalidad.', map: 'SALUD HORMONAL' },
    'Melanotan I': { objective: 'Investigaci\u00f3n de melanocortina y pigmentaci\u00f3n', community: 'Aparece en conversaciones sobre bronceado y pigmentaci\u00f3n.', evidence: 'Hablar de la v\u00eda de pigmentaci\u00f3n no establece seguridad de producto ni una recomendaci\u00f3n cosm\u00e9tica.', map: 'PIEL Y TEJIDOS' },
    'Melanotan II': { objective: 'Investigaci\u00f3n de melanocortina y pigmentaci\u00f3n', community: 'Aparece en conversaciones sobre bronceado, libido y melanocortinas.', evidence: 'Sus efectos en m\u00faltiples v\u00edas hacen particularmente enga\u00f1osas las afirmaciones casuales de estilo de vida.', map: 'PIEL Y TEJIDOS' },
    'Snap-8': { objective: 'Investigaci\u00f3n de formulaciones de p\u00e9ptidos cosm\u00e9ticos', community: 'Aparece en conversaciones sobre l\u00edneas de expresi\u00f3n y cosm\u00e9tica t\u00f3pica.', evidence: 'La evidencia depende de formulaci\u00f3n y aplicaci\u00f3n; no debe equipararse con neuromoduladores de prescripci\u00f3n.', map: 'PIEL Y TEJIDOS' },
    'Lemon Bottle': { objective: 'Referencia est\u00e9tica dependiente de formulaci\u00f3n', community: 'Aparece en conversaciones sobre est\u00e9tica y contorno corporal.', evidence: 'Un nombre comercial o de formulaci\u00f3n no es un mecanismo ni un perfil de evidencia; se deben verificar composici\u00f3n y estatus regulatorio.', map: 'PIEL Y TEJIDOS' },
    'Botulinum Toxin': { objective: 'Investigaci\u00f3n de se\u00f1alizaci\u00f3n neuromuscular', community: 'Aparece en conversaciones cl\u00ednicas y est\u00e9ticas sobre modulaci\u00f3n neuromuscular.', evidence: 'Es un medicamento regulado y dependiente de procedimiento; no es una referencia de biohacking ni una recomendaci\u00f3n de uso.', map: 'PIEL Y TEJIDOS' },
    'Hyaluronic Acid': { objective: 'Investigaci\u00f3n de matriz extracelular e hidrataci\u00f3n', community: 'Aparece en conversaciones sobre calidad de piel, tejido y procedimientos est\u00e9ticos.', evidence: 'No es un p\u00e9ptido. Su evidencia y seguridad cambian seg\u00fan la formulaci\u00f3n y el contexto profesional.', map: 'PIEL Y TEJIDOS' },
    'CJC-1295 (No DAC) + Ipamorelin': { objective: 'Comparaci\u00f3n de se\u00f1alizaci\u00f3n GHRH y grelina', community: 'Aparece en conversaciones sobre eje GH y recuperaci\u00f3n como combinaci\u00f3n de referencia.', evidence: 'No hay que sumar evidencia individual para asumir un resultado de la combinaci\u00f3n. PEPTORA no publica protocolos.', map: 'RENDIMIENTO' },
    'CagriSema Standard': { objective: 'Referencia de combinaci\u00f3n amilina e incretina', community: 'Aparece en conversaciones metab\u00f3licas que comparan se\u00f1ales de saciedad e incretinas.', evidence: 'La evidencia de una combinaci\u00f3n depende de las mol\u00e9culas, formulaci\u00f3n y poblaci\u00f3n estudiadas; no es una receta de composici\u00f3n corporal.', map: 'METAB\u00d3LICO' },
    'CagriSema High Concentration': { objective: 'Referencia de combinaci\u00f3n amilina e incretina', community: 'Aparece en las mismas conversaciones metab\u00f3licas que CagriSema Standard.', evidence: 'La concentraci\u00f3n no sustituye una evaluaci\u00f3n de evidencia, calidad o contexto cl\u00ednico.', map: 'METAB\u00d3LICO' },
    'BPC-157 + TB-500 Standard': { objective: 'Comparaci\u00f3n de se\u00f1alizaci\u00f3n de tejidos', community: 'Aparece en conversaciones sobre tejido, tend\u00f3n y recuperaci\u00f3n como una combinaci\u00f3n de referencia.', evidence: 'La literatura de los componentes no demuestra resultados cl\u00ednicos para la combinaci\u00f3n ni respalda un protocolo.', map: 'PIEL Y TEJIDOS' },
    'BPC-157 + TB-500 High Concentration': { objective: 'Comparaci\u00f3n de se\u00f1alizaci\u00f3n de tejidos', community: 'Aparece en las mismas conversaciones que la referencia BPC-157 + TB-500 est\u00e1ndar.', evidence: 'Una concentraci\u00f3n mayor no crea evidencia cl\u00ednica ni reduce la incertidumbre de una combinaci\u00f3n.', map: 'PIEL Y TEJIDOS' },
    'Bacteriostatic Water / PBS': { objective: 'Material de flujo de trabajo de laboratorio', community: 'Aparece en conversaciones sobre documentaci\u00f3n y preparaci\u00f3n de investigaci\u00f3n.', evidence: 'Es una referencia de material de laboratorio; no ofrece instrucciones de preparaci\u00f3n ni administraci\u00f3n.', map: 'HERRAMIENTAS' },
    'Benzyl Alcohol 0.9%': { objective: 'Referencia de conservante de laboratorio', community: 'Aparece en conversaciones sobre formulaci\u00f3n y documentaci\u00f3n de investigaci\u00f3n.', evidence: 'La compatibilidad, seguridad y uso dependen del contexto y especificaci\u00f3n de laboratorio; no es gu\u00eda de administraci\u00f3n.', map: 'HERRAMIENTAS' },
    'Acetic Acid 0.6%': { objective: 'Referencia de reactivo de laboratorio', community: 'Aparece en conversaciones sobre formulaci\u00f3n y manejo de muestras.', evidence: 'Su rol es de reactivo. No sustituye procedimientos validados ni indicaciones de preparaci\u00f3n.', map: 'HERRAMIENTAS' },
    Cerebrolysin: { objective: 'Investigaci\u00f3n de mezcla pept\u00eddica neurotr\u00f3fica', community: 'Aparece en conversaciones sobre neurodegeneraci\u00f3n y rehabilitaci\u00f3n cognitiva.', evidence: 'Es una mezcla pept\u00eddica compleja con literatura cl\u00ednica dependiente de contexto; no debe presentarse como nootr\u00f3pico general.', map: 'COGNICI\u00d3N' },
    DSIP: { objective: 'Investigaci\u00f3n de regulaci\u00f3n del sue\u00f1o', community: 'Aparece en conversaciones sobre sue\u00f1o y estr\u00e9s.', evidence: 'Su historia de investigaci\u00f3n es mixta y limitada; no establece un resultado de sue\u00f1o ni un protocolo autogestionado.', map: 'COGNICI\u00d3N' },
    Epitalon: { objective: 'Investigaci\u00f3n de biolog\u00eda del envejecimiento y ritmos circadianos', community: 'Aparece en conversaciones sobre longevidad y sue\u00f1o.', evidence: 'Las afirmaciones de longevidad exceden ampliamente la calidad y alcance de la evidencia humana disponible.', map: 'LONGEVIDAD' },
    Thymalin: { objective: 'Investigaci\u00f3n de p\u00e9ptidos t\u00edmicos e inmunidad', community: 'Aparece en conversaciones sobre envejecimiento inmune y resiliencia.', evidence: 'La evidencia y el contexto regulatorio cambian por jurisdicci\u00f3n e indicaci\u00f3n; evita afirmaciones inmunes generalizadas.', map: 'SALUD CELULAR' },
    VIP: { objective: 'Investigaci\u00f3n de neurop\u00e9ptido y se\u00f1alizaci\u00f3n vasoactiva', community: 'Aparece en conversaciones sobre se\u00f1alizaci\u00f3n inflamatoria, respiratoria y auton\u00f3mica.', evidence: 'Su actividad fisiol\u00f3gica amplia vuelve inapropiadas las afirmaciones simplistas de bienestar.', map: 'SALUD CELULAR' },
    FOXO4: { objective: 'Investigaci\u00f3n de senescencia celular', community: 'Aparece en conversaciones sobre longevidad y senol\u00edticos.', evidence: 'La conversaci\u00f3n senol\u00edtica es en gran parte precl\u00ednica y experimental; no establece efectos antienvejecimiento en personas.', map: 'LONGEVIDAD' },
    Glutathione: { objective: 'Investigaci\u00f3n de redox y sistemas antioxidantes', community: 'Aparece en conversaciones sobre recuperaci\u00f3n, piel y estr\u00e9s oxidativo.', evidence: 'Es un trip\u00e9ptido; las afirmaciones amplias de detox o “glow” exceden una revisi\u00f3n de evidencia dependiente de formulaci\u00f3n.', map: 'SALUD CELULAR' },
    'Ara-290': { objective: 'Investigaci\u00f3n de protecci\u00f3n de tejidos derivada de eritropoyetina', community: 'Aparece en conversaciones sobre se\u00f1alizaci\u00f3n nerviosa, dolor e inflamaci\u00f3n.', evidence: 'La investigaci\u00f3n es espec\u00edfica de indicaci\u00f3n y no debe convertirse en afirmaciones amplias de recuperaci\u00f3n o s\u00edntomas.', map: 'SALUD CELULAR' },
    'SS-31': { objective: 'Investigaci\u00f3n dirigida a mitocondria', community: 'Aparece en conversaciones sobre resiliencia mitocondrial y energ\u00eda celular.', evidence: 'El inter\u00e9s mecan\u00edstico mitocondrial no establece un resultado antienvejecimiento ni de rendimiento.', map: 'LONGEVIDAD' },
    'L-Carnitine': { objective: 'Investigaci\u00f3n de transporte de \u00e1cidos grasos y metabolismo del ejercicio', community: 'Aparece en conversaciones sobre energ\u00eda, entrenamiento y composici\u00f3n corporal.', evidence: 'No es un p\u00e9ptido y los resultados dependen de formulaci\u00f3n, poblaci\u00f3n y desenlace estudiado.', map: 'RENDIMIENTO' },
    'AOD-9604': { objective: 'Investigaci\u00f3n metab\u00f3lica de fragmento de GH', community: 'Aparece en conversaciones sobre composici\u00f3n corporal.', evidence: 'La investigaci\u00f3n temprana y dependiente de formulaci\u00f3n no establece un resultado general de p\u00e9rdida de grasa.', map: 'COMPOSICI\u00d3N CORPORAL' },
    'Thymosin Alpha-1': { objective: 'Investigaci\u00f3n de modulaci\u00f3n inmune', community: 'Aparece en conversaciones sobre resiliencia inmune.', evidence: 'Los compuestos inmunoactivos requieren contexto cl\u00ednico espec\u00edfico por indicaci\u00f3n; no es una afirmaci\u00f3n general de inmunidad.', map: 'SALUD CELULAR' },
    'LL-37': { objective: 'Investigaci\u00f3n de p\u00e9ptido antimicrobiano', community: 'Aparece en conversaciones sobre piel, heridas e inmunidad innata.', evidence: 'La biolog\u00eda antimicrobiana e inflamatoria es compleja; la investigaci\u00f3n no establece un contexto de tratamiento seguro.', map: 'SALUD CELULAR' },
    'Kisspeptin-10': { objective: 'Investigaci\u00f3n de se\u00f1alizaci\u00f3n endocrina reproductiva', community: 'Aparece en conversaciones sobre hormonas y eje de fertilidad.', evidence: 'Esta v\u00eda requiere contexto cl\u00ednico; no es un atajo de vitalidad ni rendimiento.', map: 'SALUD HORMONAL' },
  },
};
...
const PEPTORA_PRODUCTS = [
  ...
  { cat: 'gh-igf', name: 'IGF-1 LR3',
    ...
    interest: { en: 'A modified version of a natural growth factor, altered specifically so it stays active in the body longer for research purposes. Referenced in cell-proliferation and tissue-growth research literature.', es: 'Una versión modificada de un factor de crecimiento natural, alterada específicamente para que permanezca activa más tiempo con fines de investigación. Referenciado en literatura de investigación de proliferación celular y crecimiento de tejidos.' } },
  { cat: 'gh-igf', name: 'IGF-DES',
    desc: { en: 'Studied IGF-1 variant in localized tissue-growth research models.', es: 'Variante de IGF-1 estudiada en modelos de investigación de crecimiento de tejidos localizado.' },
    mech: { en: 'IGF-1 variant with greater local receptor affinity, studied in targeted tissue-research models.', es: 'Variante de IGF-1 con mayor afinidad local al receptor, estudiada en modelos de investigación de tejidos focalizada.' },
    interest: { en: 'Another IGF-1 variant, but modified for a more localized research profile rather than a broad systemic one. Studied in localized-tissue growth-factor research literature.', es: 'Otra variante de IGF-1, pero modificada para un perfil de investigación más localizado en lugar de uno sistémico amplio. Estudiado en literatura de investigación de factores de crecimiento de tejidos localizado.' } },
  ...
  { cat: 'gh-igf', name: 'BPC-157',
    desc: { en: 'Studied for angiogenesis and tissue-repair pathway research.', es: 'Estudiado en investigación de vías de angiogénesis y reparación de tejidos.' },
    ...
    interest: { en: 'Originally identified in gastric juice, this is one of the most discussed compounds in independent injury and recovery research communities. One of the most widely referenced compounds in independent tissue-repair research literature.', es: 'Identificado originalmente en el jugo gástrico, es uno de los compuestos más discutidos en comunidades independientes de investigación sobre lesiones y recuperación. Uno de los compuestos más referenciados en la literatura de investigación independiente sobre reparación de tejidos.' } },
  { cat: 'gh-igf', name: 'TB-500 (Thymosin B4 Acetate)',
    ...
    mech: { en: 'Regulates cellular actin in research models studying cell migration and tissue-repair pathways.', es: 'Regula la actina celular en modelos de investigación sobre migración celular y vías de reparación de tejidos.' },
    interest: { en: 'A synthetic version of a naturally occurring protein fragment, almost always discussed alongside BPC-157 in tissue-repair research. Frequently studied alongside BPC-157 in independent tissue-repair research literature.', es: 'Una versión sintética de un fragmento proteico natural, casi siempre discutido junto con BPC-157 en investigación de reparación de tejidos. Frecuentemente estudiado junto con BPC-157 en literatura de investigación sobre reparación de tejidos.' } },
  { cat: 'gh-igf', name: 'KPV',
  ...
  { cat: 'stacks', name: { en: 'BPC-157 + TB-500 Standard', es: 'BPC-157 + TB-500 Estándar' },
    desc: { en: 'Combined tissue-repair peptide blend for regenerative research models.', es: 'Blend combinado de péptidos de reparación de tejidos para modelos de investigación regenerativa.' },
    mech: { en: 'Combines local angiogenesis with cellular-actin regulation research for more complete tissue-repair models.', es: 'Combina angiogénesis local con regulación de actina celular para modelos de investigación de reparación de tejidos más completos.' },
    interest: { en: 'Pairs the two most frequently referenced tissue-repair peptides into a single combined research protocol. One of the most referenced combination protocols in independent tissue-repair research literature.', es: 'Combina los dos péptidos de reparación de tejidos más referenciados en un solo protocolo de investigación combinado. Uno de los protocolos combinados más referenciados en la literatura de investigación independiente sobre reparación de tejidos.' } },
  { cat: 'stacks', name: { en: 'BPC-157 + TB-500 High Concentration', es: 'BPC-157 + TB-500 Alta Concentración' },
    desc: { en: 'Higher-concentration research vial of the tissue-repair blend.', es: 'Vial de mayor concentración del blend de reparación de tejidos.' },
    mech: { en: 'Same tissue-repair research synergy, in a higher-concentration research vial.', es: 'Misma sinergia de investigación de reparación de tejidos, en un vial de mayor concentración.' },
  ...
  { cat: 'stacks', name: { en: 'GLOW', es: 'GLOW' },
    ...
    mech: { en: 'A three-compound reference combining tissue-signalling, actin-regulation and copper-peptide research contexts.', es: 'Referencia de tres compuestos que combina contextos de investigaci\u00f3n de se\u00f1alizaci\u00f3n de tejidos, regulaci\u00f3n de actina y p\u00e9ptidos de cobre.' },
    interest: { en: 'A named multi-pathway reference for tissue and dermal research discussion. It is not an independently validated combined intervention.', es: 'Referencia multiv\u00eda nombrada para conversaciones de investigaci\u00f3n de tejidos y d\u00e9rmica. No es una intervenci\u00f3n combinada validada de forma independiente.' } },
...
// The catalog has one source of truth for its active category. Re-rendering
// the compact reference cards is more reliable than hiding cards with a
// delayed animation, especially inside the collapsible mobile catalog.
function setCatalogFilter(filter) {
  const valid = filter === 'all' || PEPTORA_PRODUCTS.some(product => product.cat === filter);
  CURRENT_FILTER = valid ? filter : 'all';
  const catalog = document.querySelector('.catalog-details');
  if (catalog) catalog.open = true;
  document.querySelectorAll('.filter-pill').forEach(pill => {
    pill.classList.toggle('active', pill.getAttribute('data-filter') === CURRENT_FILTER);
  });
  renderProducts();
}
...
function renderProducts() {
  ...
  const visibleProducts = CURRENT_FILTER === 'all'
    ? PEPTORA_PRODUCTS
    : PEPTORA_PRODUCTS.filter(product => product.cat === CURRENT_FILTER);

  grid.innerHTML = visibleProducts.map((p) => {
    const name = nameOf(p);
    // Translated labels keep the stable English name as a fallback profile key.
    const referenceName = typeof p.name === 'string' ? p.name : p.name.en;
    const catLabel = CAT_LABELS[lang][p.cat] || p.cat;
    const categoryLens = BIOHACKING_LENS[lang][p.cat] || BIOHACKING_LENS.en[p.cat];
    const lens = BIOHACKING_LENS_BY_PRODUCT[lang][name] || BIOHACKING_LENS_BY_PRODUCT[lang][referenceName] || {
      objective: p.mech[lang],
      community: p.interest[lang],
      evidence: categoryLens.evidence,
      map: categoryLens.map,
    };
  ...
  if (countEl) countEl.textContent = CURRENT_LANG === 'es'
    ? `${visibleProducts.length} compuestos`
    : `${visibleProducts.length} compounds`;
}
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (filterRow) {
    filterRow.addEventListener('click', (event) => {
      ...
      if (!pill) return;
      setCatalogFilter(pill.getAttribute('data-filter'));
    });
  }
...
Object.assign(I18N.es, {
  ...
  'objective.1': 'METAB\u00d3LICO', 'objective.2': 'RENDIMIENTO', 'objective.3': 'RECUPERACI\u00d3N', 'objective.4': 'COGNICI\u00d3N', 'objective.5': 'LONGEVIDAD', 'objective.6': 'SALUD CELULAR', 'objective.7': 'COMPOSICI\u00d3N CORPORAL', 'objective.8': 'PIEL Y TEJIDOS', 'objective.9': 'HERRAMIENTAS DE INVESTIGACI\u00d3N',
