...
const BIOHACKING_LENS_BY_PRODUCT = {
  en: {
    ...
    Tesamorelin: { objective: 'GHRH & visceral-adiposity research', community: 'Appears in body-composition conversations, but its strongest human research context is HIV-associated abdominal adiposity.', evidence: 'Do not generalize clinical findings in a defined population to healthy people or physique goals.', map: 'BODY COMPOSITION' },
  ...
  es: {
    ...
    Tesamorelin: { objective: 'Investigaci\u00f3n de GHRH y adiposidad visceral', community: 'Aparece en conversaciones sobre composici\u00f3n corporal, pero su contexto humano m\u00e1s fuerte es la adiposidad abdominal asociada a VIH.', evidence: 'No se deben generalizar hallazgos cl\u00ednicos de una poblaci\u00f3n definida a personas sanas u objetivos de f\u00edsico.', map: 'COMPOSICI\u00d3N CORPORAL' },
